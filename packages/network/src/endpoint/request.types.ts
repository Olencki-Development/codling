...
type GetParamInput<T_Pathname extends Pathname> =
  RequestParams<T_Pathname> extends Record<string, never>
    ? { params?: Record<string, never> }
    : { params: RequestParams<T_Pathname> };
type GetQueryInput<T_Query extends z.SomeZodObject> =
  T_Query extends EmptyZodObject
    ? { query?: Record<string, never> }
    : { query: z.input<T_Query> };
type GetBodyInput<T_Body extends z.ZodTypeAny> = T_Body extends z.ZodUnknown
  ? { body?: unknown }
  : { body: z.input<T_Body> };
